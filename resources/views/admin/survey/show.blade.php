                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        @if($survey->photo_1)
                                            <img src="{{ asset('storage/' . $survey->photo_1) }}" alt="Photo 1" class="img-fluid" style="max-width: 200px;">
                                        @else
                                            No photo available
                                        @endif
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        @if($survey->photo_2)
                                            <img src="{{ asset('storage/' . $survey->photo_2) }}" alt="Photo 2" class="img-fluid" style="max-width: 200px;">
                                        @else
                                            No photo available
                                        @endif
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        @if($survey->photo_3)
                                            <img src="{{ asset('storage/' . $survey->photo_3) }}" alt="Photo 3" class="img-fluid" style="max-width: 200px;">
                                        @else
                                            No photo available
                                        @endif
                                    </td>
